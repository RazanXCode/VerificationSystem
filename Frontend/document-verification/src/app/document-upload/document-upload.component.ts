...
export class DocumentUploadComponent {
  ...
  uploadDocument(): void {
    ...
    // If there are validation errors, don't proceed with upload
...
//   document: any = { name: '', file: null };
//   message: string = '';
//   errors: string[] = [];  // Local errors to show before redux dispatch
...
//     this.http.post('http://localhost:5075/api/documents', formData).subscribe({
//       next: (response) => {
//         store.dispatch(uploadSuccess('Document uploaded successfully!'));
//         this.message = 'Document uploaded successfully!';
//       },
//       error: (error) => {
//         store.dispatch(uploadFailure('Error uploading document.'));
//         this.message = 'Error uploading document.';
//       }
//     });
//   }
